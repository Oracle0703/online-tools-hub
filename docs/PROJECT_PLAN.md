...
| 候选发布预检 | 真实 Edge/Windows 与 Safari/macOS；上传 JSON 记录和截图 |
...
完整范围、非目标、技术边界、性能预算和阶段 Issue 见 [v1.0 路线图](V1_ROADMAP.md)。离线缓存谓词、下载协议、更新边界和机器隐私清单见 [PWA 离线包与隐私能力中心](PWA_PRIVACY_CENTER.md)。完整英文版本仍是候选能力，只有在全部公共页面内容齐备并通过 locale SEO 门禁后才开放路由。
